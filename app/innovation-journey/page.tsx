    ...
    <section style={{
      ...
      <div style={{
        ...
        <h1 style={{
          ...
          The{' '}
          <span style={{ color: TEAL }}>Innovation</span>
          <br />Journey
        </h1>
        ...
        <p style={{
          ...
          Structured corporate innovation programs connecting established companies with
          DeepTech startups and research institutions across the Franco-German corridor.
        </p>
